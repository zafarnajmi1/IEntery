...
struct userCompanyRestrictionModelData : Codable {
    ...
    let alertTimeIncomingEvent : Bool?
    let alertTimeIncomingInvitation : Bool?
    ...
    init(from decoder: Decoder) throws {
        ...
        alertTimeIncomingEvent = try values.decodeIfPresent(Bool.self, forKey: .alertTimeIncomingEvent)
        alertTimeIncomingInvitation = try values.decodeIfPresent(Bool.self, forKey: .alertTimeIncomingInvitation)
